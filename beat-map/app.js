var music = (function() {
  ...
  var _toInferredProperties = function _toInferredProperties(
    properties,
    value
  ) {
   ...
   */
    ...
    return {
      play: function play() {
        ...
        var endTime = now + (resonance * length) / 1000 + 0.01;
        ...
        // setting values
        gain.gain.value = 0.5;
        gain.gain.exponentialRampToValueAtTime(0.001, cutoff);
  ...
  var shorthand = [
    "C4@16,E,G,C5,E,G4,C5,E",
    "C4,E,G,C5,E,G4,C5,E",
    "C4,D,A,D5,F,A4,D5,F",
    "C4,D,A,D5,F,A4,D5,F",
    "B3,D4,G,D5,F,G4,D5,F",
    "B3,D4,G,D5,F,G4,D5,F",
    "C4,E,G,C5,E,G4,C5,E",
    "C4,E,G,C5,E,G4,C5,E",
    "C4,E,A,E5,A,A4,E5,A",
    "C4,E,A,E5,A,A4,E5,A",
    "C4,D,Fs,A,D5,Fs4,A,D5",
    "C4,D,Fs,A,D5,Fs4,A,D5",
    "B3,D4,G,D5,G,G4,D5,G",
    "B3,D4,G,D5,G,G4,D5,G",
    "B3,C4,E,G,C5,E4,G,C5",
    "B3,C4,E,G,C5,E4,G,C5",
    "A3,C4,E,G,C5,E4,G,C5",
    "A3,C4,E,G,C5,E4,G,C5",
    "D3,A,D4,Fs,C5,D4,Fs,C5",
    "D3,A,D4,Fs,C5,D4,Fs,C5",
    "G3,B,D4,G,B,D,G,B",
    "G3,B,D4,G,B,D,G,B",
    "G3,Bb,E4,G,Cs5,E4,G,Cs5",
    "G3,Bb,E4,G,Cs5,E4,G,Cs5",
    "F3,A,D4,A,D5,D4,A,D5",
    "F3,A,D4,A,D5,D4,A,D5",
    "F3,Ab,D4,F,B,D,F,B",
    "F3,Ab,D4,F,B,D,F,B",
    "E3,G,C4,G,C5,C4,G,C5",
    "E3,G,C4,G,C5,C4,G,C5",
    "E3,F,A,C4,F,A3,C4,F",
    "E3,F,A,C4,F,A3,C4,F",
    "D3,F,A,C4,F,A3,C4,F",
    "D3,F,A,C4,F,A3,C4,F",
    "G2,D3,G,B,F4,G3,B,F4",
    "G2,D3,G,B,F4,G3,B,F4",
    "C3,E,G,C4,E,G3,C4,E",
    "C3,E,G,C4,E,G3,C4,E",
    "C3,G,Bb,C4,E,Bb3,C4,E",
    "C3,G,Bb,C4,E,Bb3,C4,E",
    "F2,F3,A,C4,E,A3,C4,E",
    "F2,F3,A,C4,E,A3,C4,E",
    "Fs2,C3,A,C4,Eb,A3,C4,Eb",
    "Fs2,C3,A,C4,Eb,A3,C4,Eb",
    "Ab2,F3,B,C4,D,B3,C4,D",
    "Ab2,F3,B,C4,D,B3,C4,D",
    "G2,F3,G,B,D4,G3,B,D4",
    "G2,F3,G,B,D4,G3,B,D4",
    "G2,E3,G,C4,E,G3,C4,E",
    "G2,E3,G,C4,E,G3,C4,E",
    "G2,D3,G,C4,F,G3,C4,F",
    "G2,D3,G,C4,F,G3,C4,F",
    "G2,D3,G,B,F4,G3,B,F4",
    "G2,D3,G,B,F4,G3,B,F4",
    "G2,Eb3,A,C4,Fs,A3,C4,Fs",
    "G2,Eb3,A,C4,Fs,A3,C4,Fs",
    "G2,E3,G,C4,G,G3,C4,G",
    "G2,E3,G,C4,G,G3,C4,G",
    "G2,D3,G,C4,F,G3,C4,F",
    "G2,D3,G,C4,F,G3,C4,F",
    "G2,D3,G,B,F4,G3,B,F4",
    "G2,D3,G,B,F4,G3,B,F4",
    "C2,C3,G,Bb,E4,G3,Bb,E4",
    "C2,C3,G,Bb,E4,G3,Bb,E4",
  ...
  var addClass = function addClass(_ref) {
    ...
    var parent = document
      .querySelector(".name--" + name + ".octave--" + octave)
      .classList.add("active");
  };

  var music = parseShorthand(shorthand)
    .map(withPitch)
    .map(withLength)
    .map(withStart)
    .map(withResonance(7))
